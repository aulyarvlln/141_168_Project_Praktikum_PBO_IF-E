...
public class EventVendorDTO {
    ...
    public double getHargaPakai() { 
        return hargaPakai; }
    public void setHargaPakai(double hargaPakai) { 
        this.hargaPakai = hargaPakai; }
    ...
    public String getVendorKategori() { 
        return vendorKategori; }
    public void setVendorKategori(String vendorKategori) { 
        this.vendorKategori = vendorKategori; }
}